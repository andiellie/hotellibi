  ...
  return (
    <section id="clientes" className="px-5 py-24 sm:py-32">
      <div className="mx-auto max-w-6xl text-center">
        ...
        <div className="mt-16 grid grid-cols-2 items-center justify-items-center gap-x-8 gap-y-12 font-sans opacity-80 sm:grid-cols-4">
          ...
          <div className="text-center">
            ...
            <p className="text-xs tracking-widest text-on-dark-secondary">L&apos;Hôtel Palermo</p>
          </div>

          <div className="text-center">
            <p className="text-2xl font-black tracking-tight text-white">BENS</p>
            <p className="text-xs tracking-[0.3em] text-on-dark-secondary">Recoleta Park</p>
          </div>
